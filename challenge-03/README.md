...
*/
pessoa.nomeCompleto() // Olá! Meu nome é Rafael Praia

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade() // lá, eu tenho 40 anos
...
*/
pessoa.fazerAniversario() // executei o comando 3x
...
*/
pessoa.caminhouQuantosMetros // 20 pois eu já havia testado o método uma vez com o valor 5
...
pessoa.apresentacao = function() {
  ...
  if( pessoa.caminhouQuantosMetros === 1 ) { sexo = 'metro'; }
