(function() { // start IIFE
	...
	*/
	function isOperatorValid( operator ) {
		...
		// a solução acima não está errada mas é muito longa

		// return operation[operator] !== undefined;
		// versão mais curta - passada pelo instrutor

		return !!operation[operator];
		// versão mais curta 2 - passada pelo instrutor
