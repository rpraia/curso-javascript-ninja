...
( function() {
	...
	*/
	...
	console.log( text.replace( /Manuel Marques de Sousa/, 'Rafael Praia' ) );
	...
	*/
	...
	function getMonthNumber( month ) {
		...
		switch( month ) {
			...
			case 'agosto' : num = '08';
			break;
			case 'setembro' : num = '09';
			break;
			case 'outubro' : num = '10';
			break;
			case 'novembro' : num = '11';
			break;
			case 'dezembro' : num = '12';
			break;
		};
		return num;
	}
	*/
	...
	function returnMonthNumber( month ) {
		return 'O mês de ' + month + ' é representado pelo número ' + getMonthNumber( month ) + '.';
	}

	console.log( returnMonthNumber( 'março' ) );
	console.log( returnMonthNumber( 'setembro' ) );
	console.log( returnMonthNumber( 'dezembro' ) );
