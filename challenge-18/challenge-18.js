( function() {
	...
	*/
	...
	// var formatFunc = function( regex, a, b, c, d ) { return a + '.' + b + '.' + c + '-' + d; } ;
	console.log( '\nFormatando CPFs corretamente:' );
	cpfs.forEach( function( cpf ) {
		console.log( cleanCPF( cpf ).replace( format, '$1.$2.$3-$4' ) );
	} )
	...
	*/
	...
	var baseText = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
	var myRegex = /<(\w+)>([^<]+)<\/\w+>/g;
