...
- reduce(function(valorAcumulado, valorAtual, index, array) {}, 0) --> soma ou concatena itens - da esquerda para direita
- reduceRight(function(valorAcumulado, valorAtual, index, array) {}, 0)soma ou concatena itens - da direita pa a esquerda
- indexOf( valor, index )
- lastIndexOf( valor, index )
- Array.isArray()
...
( function() {
	...
	*/
	...
	var verify = numberObjects.indexOf( {number: 2} );
	...
	*/
	...
	var verify2 = numberObjects.lastIndexOf( {number: 2}, 2 );
